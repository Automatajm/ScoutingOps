  ...
  Future<void> _saveMonitoreo() async {
    ...
    try {
      ...
      final nivelAutomatico1 = NivelCalculator.calcularNivelAutomatico(
        muestra1 > 0 ? muestra1 : null,
        _limiteNivel1,
        _limiteNivel2,
      );

      final nivelAutomatico2 = NivelCalculator.calcularNivelAutomatico(
        muestra2 > 0 ? muestra2 : null,
        _limiteNivel1,
        _limiteNivel2,
      );

      final nivelAutomatico3 = NivelCalculator.calcularNivelAutomatico(
        muestra3 > 0 ? muestra3 : null,
        _limiteNivel1,
        _limiteNivel2,
      );
      ...
      final monitoreo = Monitoreo(
        ...
        pmmo_canteros: canterosParaGuardar,
      ...
      debugPrint('📦 [MONITOREO] Objeto creado con niveles automáticos:');
